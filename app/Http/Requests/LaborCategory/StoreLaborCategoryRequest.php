...
class StoreLaborCategoryRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'cost.required' => 'Labor Category cost is required',
            'cost.numeric' => 'Labor Category cost must be a number',
            'selling_price.required' => 'Labor Category selling price is required',
            'selling_price.numeric' => 'Labor Category selling price must be a number',
        ];
    }
